...
param lina_dbserver_outputs_name string

param lina_dbserver_outputs_sqlserveradminname string
...
resource lina_dbserver 'Microsoft.Sql/servers@2023-08-01' existing = {
  name: lina_dbserver_outputs_name
}

resource sqlServerAdmin 'Microsoft.ManagedIdentity/userAssignedIdentities@2024-11-30' existing = {
  name: lina_dbserver_outputs_sqlserveradminname
}
...
resource script_lina_dbserver_DefaultConnection 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('lina_dbserver', principalName, 'DefaultConnection', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
  ...
  properties: {
    ...
    environmentVariables: [
      ...
      {
        name: 'DBSERVER'
        value: lina_dbserver.properties.fullyQualifiedDomainName
      }
      {
        name: 'PRINCIPALTYPE'
        value: principalType
